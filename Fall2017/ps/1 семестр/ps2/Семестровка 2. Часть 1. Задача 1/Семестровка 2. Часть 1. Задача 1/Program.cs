...
namespace Семестровка_2.Часть_1.Задача_1
{
    class Program
    {
        static double Consider(double x, int step)  //Метод суммирования
        {
            ...
            {
                numerator *= x;  //Начиная с 1-го шага, числитель каждый раз умножаем на x, знаменатель на номер шага
                denumerator *= i;
                sum += numerator / denumerator;  //увеличиваем значеие суммы
            }
            return sum;
        }
